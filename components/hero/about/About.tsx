        ...
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <div className="space-y-4 text-[#000000]">
            <p className="text-lg md:text-xl  leading-relaxed">
              Potenciamos empresas a través de soluciones tecnológicas innovadoras. 
              Nuestra experiencia nos permite entender las necesidades únicas de 
              cada cliente y transformarlas en soluciones efectivas.
            </p>
